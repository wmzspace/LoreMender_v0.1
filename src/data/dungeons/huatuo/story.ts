...
export const STORY: Record<string, StoryChapter> = {
    ...
    beats: [
        ...
        explore: {
          ...
          hotspots: [
            ...
            },
            {
              ...
              beats: [
                { speaker: "aj", line: "这是我从前随师父出诊穿的衣服……还有半张出入牌。" },
                { speaker: "huatuo", line: "狱卒认不全弟子，只认印记。你若想走出去，就得先让这块牌子能过门。" },
                { narration: true, line: "获得：旧医徒衣、半张出入牌。出入牌还缺华佗印记，暂时不能用。" },
              ],
            },
            {
              id: "door",
      ...
      { speaker: "huatuo", line: "因为缺的地方，要你一路去补。" },
      {
        game: {
          ...
          nextBeatUnlocked: "木盒暗格合上，残页暂时藏住。半张出入牌也补上华佗印记，足以骗过牢门。",
          context: "用生锈铜钥匙解开木盒机关，再把青囊残页藏入夹层，补全弟子出入牌。藏得越稳，后续追索压力越低。",
      ...
      { speaker: "guard", line: "华佗门下的？这么晚还出去？" },
      { speaker: "aj", line: "曹府要核药册，误了时辰，小的担不起。" },
      { speaker: "guard", line: "低头。盒子打开。" },
      { speaker: "aj", line: "里面是空盒，装药包用的。" },
      { speaker: "guard", line: "快滚。天亮前别让我再看见你。" },
      { speaker: "huatuo", line: "阿吉。出入牌只能骗过门，骗不过你自己的心。出去以后，每一步都算数。" },
      { narration: true, line: "阿吉穿着旧医徒衣，拿着华佗补过印的出入牌，从侧门离开大牢。曹府暂时还以为残卷留在牢中；等点验发现木盒空响，追索才会开始。" },
      { gotoChapter: "ch2" },
    ],
  },
  ...
  ch2: {
    ...
    beats: [
      ...
      { speaker: "chenbo", line: "曹府今日查得紧，你这身医徒衣撑不了多久。" },
      ...
      { narration: true, line: "曹府搜查药市。阿吉发现单靠弟子出入牌撑不过下一轮盘查，只能主动冒险进入曹府档案区。" },
      { gotoChapter: "ch3" },
    ],
  },
  ...
  ch3: {
    ...
    beats: [
      { narration: true, line: "曹府外院朱门半开，药房小吏来回搬运药箱。阿吉压低帽檐，把弟子出入牌藏在袖中。" },
      { speaker: "clerk", line: "哪位医者门下？" },
      { speaker: "aj", line: "牢中旧药补送，按曹府药房缺册来的。" },
      { speaker: "clerk", line: "出入牌。" },
      {
        ifKey: "boxCompartment",
        ifVal: "found",
        beats: [
      ...
      },
      {
        ...
        ifVal: "missed",
        beats: [
          { narration: true, line: "出入牌缺角，药签也还不够干净。阿吉只能绕过守卫，从药房后窗翻入。追索压力又紧了一分。" },
        ],
      },
