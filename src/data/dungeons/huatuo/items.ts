...
export const ITEMS: Record<string, ItemDef> = {
  ...
  old_healer_clothes: { id: "old_healer_clothes", name: "旧医徒衣", image: `${IMG}/item_old_healer_clothes.webp`, desc: "随师父出诊时穿的旧衣，能掩去囚徒气息。" },
  entry_pass:         { id: "entry_pass", name: "半张出入牌", image: `${IMG}/item_entry_pass.webp`, desc: "出入牌还缺华佗印记，暂时不能用。" },
  ...
  travel_pass:         { id: "travel_pass", name: "出入凭牌" },
