...
export const CHARACTER_VOICES: Record<string, VoiceSetting> = {
  ...
  woman: { voice: "zh-CN-XiaoxiaoNeural", rate: "+3%", pitch: "+8Hz" },
  child: { voice: "zh-CN-XiaoyiNeural", rate: "+8%", pitch: "+18Hz" },
  passerby: { voice: "zh-CN-YunxiNeural", rate: "+5%", pitch: "+2Hz" },
  tea_guest: { voice: "zh-CN-YunxiNeural", rate: "-2%", pitch: "-2Hz" },
  busker: { voice: "zh-CN-YunjianNeural", rate: "+6%", pitch: "+8Hz" },
  patrol: { voice: "zh-CN-YunyangNeural", rate: "+10%", pitch: "-8Hz", volume: "+20%" },
};
