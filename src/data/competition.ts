...
export const LEVEL_ASSET_PLANS: LevelAssetPlan[] = [
  {
    ...
    imagePath: "/images/levels/1/chapters/chapter01_prison.webp",
  ...
  },
  {
    ...
    imagePath: "/images/levels/1/chapters/chapter02_three_people.webp",
  ...
  },
  {
    ...
    imagePath: "/images/levels/1/chapters/chapter03_cao_mansion.webp",
  ...
  },
  {
    ...
    imagePath: "/images/levels/1/chapters/chapter04_choice.webp",
  ...
  },
  {
    ...
    imagePath: "/images/levels/1/chapters/chapter05_echo.webp",
...
export const AI_WORKFLOW_RECORDS: AiWorkflowRecord[] = [
  ...
  },
  {
    title: "插图生成",
    tool: "比赛指定 AI 绘图工具",
    output: "按五章分别生成封面级场景图，替换 public/images/levels/1/chapters/*.png。",
  ...
  },
  {
    title: "BGM 生成",
    tool: "比赛指定 AI 音乐工具",
    output: "生成封面、五章和结局可循环 BGM，放入 public/audio/levels/1/bgm/。",
