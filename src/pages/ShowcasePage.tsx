...
export function ShowcasePage({ onBack, onEnter, embedded }: ShowcasePageProps) {
  return (
    <PageShell eyebrow="AI CAN DO IT" title="参 赛 档 案" onBack={onBack} bg={embedded ? "" : "night-bg"}>
      ...
      <div className="lore-card fade-up" style={{ marginBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-start" }}>
          <div>
            <div className="lore-card-title" style={{ fontSize: 20, marginBottom: 8 }}>赛道方向</div>
            <div className="lore-card-line" style={{ fontSize: 14.5, lineHeight: 1.8 }}>
