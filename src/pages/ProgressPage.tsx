...
export function ProgressPage({ state, gotoPage }: ProgressPageProps) {
  ...
  return (
    <div className="page night-bg">
      <Topbar title="第一卷进程" onBack={() => gotoPage("story")} />
      <div className="page-scroll" style={{ top: 56, bottom: 74, padding: "0 16px 20px" }}>
                    ...
                    {games.map(game => {
                      ...
                      return (
                        <div key={game.id} style={{
                          ...
                          <span style={{ color: result?.completed ? "var(--jade-pale)" : "var(--paper)", opacity: hasRequired ? 0.9 : 0.45, fontSize: 11 }}>
